...
public class MenuController extends BaseController {
	...
	public Collection<PermissionForm> getAvaliblePage() {
		Map<String, PageEntity> pageMap = PermissionManager.getInstance()
				.getMenuMap();
		Collection<PermissionForm> collection = new ArrayList<PermissionForm>();
		for (PageEntity p : pageMap.values()) {
	...
	public Collection<PermissionForm> getFunctionByPage(
		...
		PageEntity page = PermissionManager.getInstance().getPageByCode(pageCode);
		Collection<PermissionForm> collection = new ArrayList<PermissionForm>();
		for (FunctionEntity f : page.getFuns().values()) {
			PermissionForm form = new PermissionForm();
	...
	@ResponseBody
	public Map<String, Object> deletePage(PageEntity page) {
		Map<String, Object> resMap = new HashMap<String, Object>();
		resMap.put("success", true);
		return resMap;
	}
